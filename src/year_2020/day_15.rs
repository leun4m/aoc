...
mod test {
    ...
    #[test]
    fn example() {
        assert_eq!(1, play(&[1, 3, 2]));
        assert_eq!(10, play(&[2, 1, 3]));
        assert_eq!(27, play(&[1, 2, 3]));
        assert_eq!(78, play(&[2, 3, 1]));
        assert_eq!(438, play(&[3, 2, 1]));
        assert_eq!(1836, play(&[3, 1, 2]));
    }
}
